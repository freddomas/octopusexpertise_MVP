...
Follow the repository's branch and isolation policy. When isolation is required,
use using-git-worktrees to create or verify the workspace. Do not add a consent
checkpoint when current instructions already authorize working on the active
branch.
