...
- **Sanity** — use its official GROQ, mutation, and CLI documentation
- **Contentful** — use its official Delivery and Management API documentation
- **Strapi** — use its official REST, filter, and document API documentation
